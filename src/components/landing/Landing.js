...
const Landing = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-white text-3xl md:text-3xl lg:text-4xl font-semibold tracking-tight truncate">
          Devi R
        </h1>
      </Link>
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-[#A1F6FF] text-left max-w-4xl px-8 backdrop-blur-sm">
          <h1 className="text-3xl md:text-3xl lg:text-4xl font-bold mb-8">
            Beyond the 'what', <br />
            this is the 'how'.
          </h1>
          <p className="text-[#A7D1D7] text-base md:text-base lg:text-xl mb-6 leading-relaxed">
          ...
          <Link
            ...
            className="mt-10 md:mt-16 inline-block bg-[#193C50] text-[#0F2430] border border-[#193C50] px-8 py-3 rounded-[1000px] font-semibold text-[#CDEBEE] text-base md:text-base lg:text-lg hover:bg-[#0D212E] hover:border-[#153243] transition-colors duration-200"
          >
